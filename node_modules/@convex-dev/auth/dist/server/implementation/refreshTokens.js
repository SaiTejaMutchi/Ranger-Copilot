 ...
 * @param refreshToken
 */
export async function invalidateRefreshTokensInSubtree(ctx, refreshToken) {
...
export async function deleteAllRefreshTokens(ctx, sessionId) {
...
export async function refreshTokenIfValid(ctx, refreshTokenId, tokenSessionId) {
 ...
 * @param sessionId
 */
export async function loadActiveRefreshToken(ctx, sessionId) {
    return ctx.db
        .query("authRefreshTokens")
