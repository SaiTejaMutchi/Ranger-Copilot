...
export async function handleAuthenticationInRequest(request, verbose, cookieConfig) {
...
async function getRefreshedTokens(verbose) {
    ...
    try {
        ...
        logVerbose(`Successfully refreshed tokens: is null? ${result.tokens === null}`, verbose);
