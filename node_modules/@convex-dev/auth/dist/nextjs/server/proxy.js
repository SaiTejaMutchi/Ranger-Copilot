...
import { getRedactedMessage, isCorsRequest, jsonResponse, logVerbose, setAuthCookies, } from "./utils.js";
export async function proxyAuthActionToConvex(request, options) {
    ...
    logVerbose(`Fetching action ${action} with args ${JSON.stringify({
        ...args,
