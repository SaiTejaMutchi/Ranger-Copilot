...
import {
  ...
  version
} from "./chunk-DHTZNOJ6.js";
import {
  require_react
} from "./chunk-MJUBBHQQ.js";
import {
  __toESM,
  require_dist,
  require_dist2,
  require_dist3
} from "./chunk-T2FCJJ2V.js";
...
var RequestManager = class {
  constructor(logger, markConnectionStateDirty) {
    ...
    __publicField3(this, "inflightMutationsCount", 0);
    __publicField3(this, "inflightActionsCount", 0);
...
var WebSocketManager = class {
  constructor(uri, callbacks, webSocketConstructor, logger, markConnectionStateDirty, debug) {
    ...
    __publicField7(this, "_hasEverConnected", false);
    __publicField7(this, "lastCloseReason");
    __publicField7(this, "transitionChunkBuffer", null);
    __publicField7(this, "defaultInitialBackoff");
    ...
    __publicField7(this, "scheduledReconnect", null);
    __publicField7(this, "networkOnlineHandler", null);
    __publicField7(this, "pendingNetworkRecoveryInfo", null);
    ...
    __publicField7(this, "onServerDisconnectError");
  ...
  scheduleReconnect(reason) {
    ...
    const timeoutId = setTimeout(() => {
      var _a;
      if (((_a = this.scheduledReconnect) == null ? void 0 : _a.timeout) === timeoutId) {
        this.scheduledReconnect = null;
        this.connect();
      }
    }, backoff);
...
var AuthenticationManager = class {
  constructor(syncState, callbacks, config) {
    ...
    __publicField8(this, "tryRestartSocket");
    ...
    __publicField8(this, "tokenConfirmationAttempts", 0);
...
var BaseConvexClient = class {
  ...
  constructor(address, onTransition, options) {
    ...
    __publicField9(this, "connectionStateSubscribers", /* @__PURE__ */ new Map());
    __publicField9(this, "nextConnectionStateSubscriberId", 0);
    __publicField9(this, "_lastPublishedConnectionState");
    __publicField9(this, "markConnectionStateDirty", () => {
...
var PaginatedQueryClient = class {
  constructor(client, onTransition) {
    ...
    __publicField10(this, "paginatedQuerySet", /* @__PURE__ */ new Map());
    __publicField10(this, "lastTransitionTs");
...
var ConvexHttpClient = class {
  ...
  constructor(address, options) {
    ...
    this.logger = (options == null ? void 0 : options.logger) === false ? instantiateNoopLogger({ verbose: false }) : (options == null ? void 0 : options.logger) !== true && (options == null ? void 0 : options.logger) ? options.logger : instantiateDefaultLogger({ verbose: false });
    this.address = address;
    this.debug = true;
    this.auth = void 0;
    this.adminAuth = void 0;
    this.fetch = options == null ? void 0 : options.fetch;
  ...
  async mutation(mutation, ...args) {
    ...
    const queued = !(options == null ? void 0 : options.skipQueue);
    if (queued) {
...
var ConvexReactClient = class {
  ...
  constructor(address, options) {
    ...
    __publicField12(this, "cachedSync");
    __publicField12(this, "cachedPaginatedQueryClient");
    __publicField12(this, "listeners");
    __publicField12(this, "options");
    __publicField12(this, "closed", false);
    __publicField12(this, "_logger");
    __publicField12(this, "adminAuth");
    __publicField12(this, "fakeUserIdentity");
    if (address === void 0) {
      throw new Error(
    ...
    this._logger = (options == null ? void 0 : options.logger) === false ? instantiateNoopLogger({ verbose: (options == null ? void 0 : options.verbose) ?? false }) : (options == null ? void 0 : options.logger) !== true && (options == null ? void 0 : options.logger) ? options.logger : instantiateDefaultLogger({ verbose: (options == null ? void 0 : options.verbose) ?? false });
...
var QueriesObserver = class {
  constructor(createWatch) {
    __publicField13(this, "createWatch");
    __publicField13(this, "queries");
...
function usePaginatedQuery_experimental(query, args, options) {
  ...
  if (result instanceof Error) {
    if (result.message.includes("InvalidCursor") || result instanceof ConvexError && typeof result.data === "object" && ((_a = result.data) == null ? void 0 : _a.isConvexSystemError) === true && ((_b = result.data) == null ? void 0 : _b.paginationError) === "InvalidCursor") {
      logger.warn(
...
var paginationId2 = 0;
function nextPaginationId2() {
  paginationId2++;
  return paginationId2;
}
...
function useConvexAuth() {
  const authContext = (0, import_react6.useContext)(ConvexAuthContext);
...
function ConvexProviderWithAuth({
  ...
  const [isConvexAuthenticated, setIsConvexAuthenticated] = (0, import_react6.useState)(null);
  ...
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(ConvexProvider, { client }, children),
    import_react6.default.createElement(
...
function usePreloadedQuery(preloadedQuery) {
  ...
  const preloadedResult = (0, import_react8.useMemo)(
...
//# sourceMappingURL=chunk-Z2V4ZDSS.js.map
